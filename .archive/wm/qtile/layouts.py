    ...
    floating_layout = Floating(
        float_rules=[
            *Floating.default_float_rules,
            ...
            Match(wm_class='tagstudio', title='Add Tag'),
            Match(wm_class='tagstudio', title='Add Tags'),
            Match(wm_class='tagstudio', title='New Tag'),
            Match(wm_class='tagstudio', title='Edit Tag'),
            Match(wm_class='tagstudio', title='Library Tags'),
            Match(wm_class='tagstudio', title='Add Parent Tags'),
            Match(wm_class='tagstudio', title='Add Field'),
        ]
    )
...
def init_groups():
    ...
    return [
        ...
        ScratchPad('terminal', [
            DropDown('terminal', 'ghostty --title=scratchpad', **large_centered_kwargs),
        ])
    ]
